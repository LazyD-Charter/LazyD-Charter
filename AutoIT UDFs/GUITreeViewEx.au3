...
#forcedef $aTV_Event, $iTotalSizeBytes

					Local $aTV = $aTV_Event[0]
					...
					$iTotalSizeBytes = ($aTV[$iAlteredIndex][0] = 0) ? ($iTotalSizeBytes + $iSign * $aTV[$iAlteredIndex][15]) : ($iTotalSizeBytes) ; if file
