...
; Change these two variables according to your need, I need the $sInstallPath variable (which is set in the calling script). It is not used anywhere throughout this script.
; Remove/Comment the next two lines, and Uncomment/Enter path to ico files in the line right below these
#forcedef $g_sInstallPath
Global $g_sIconFolder = $g_sInstallPath & "\Apps\ChResource\"

;Global $g_sIconFolder = ""
