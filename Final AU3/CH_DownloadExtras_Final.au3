...
#AutoIt3Wrapper_Outfile=CH_Install\Scripts\CH_DownloadExtras.a3x
...
Global $g_sSharedFolderID = IniRead($g_sIniFile,"Install","Extras_Folder_ID","NotRead")  ; testfolder
...
func CreateAppWindow()
	...
	Local $hAppWindow = GUICreate("LazyD Charter - Download Extras",830,545,-1,-1,-1,-1)
	...
	GUICtrlCreateLabel("Application window may report unresponsive during downloading of files!",10,10,800,20,-1,-1)
	GUICtrlSetFont(-1, 14, 400, 0, "")
	GUICtrlSetColor(-1, $COL_BTN_QUIT)
	GUICtrlSetBkColor(-1,$COL_APP_WINDOW)

	;Create New Content label
	GUICtrlCreateLabel("Extras Content (Missing on this PC)",10,45,400,20,-1,-1)
	GUICtrlSetFont(-1, 14, 400, 0, "")
	GUICtrlSetBkColor(-1,$COL_GROUP_HEADER)

	;Create Updated Content Label
	GUICtrlCreateLabel("All Content (Informational)",420,45,400,20,-1,-1)
	GUICtrlSetFont(-1, 14, 400, 0, "")
	GUICtrlSetBkColor(-1,$COL_GROUP_HEADER)
	...
	$g_idTV_Updated = GUICtrlCreateTreeView(420,70,400,300,$GUI_SS_DEFAULT_TREEVIEW,-1) ; BitOR($GUI_SS_DEFAULT_TREEVIEW, $TVS_CHECKBOXES),-1)
	GUICtrlSetBkColor(-1, $COL_GROUP)
	GUICtrlSetFont(-1, 12, 400, 0, "")

	;Create CHECK for updated files Button
	Local $iBtn_Check = GUICtrlCreateButton("CHECK EXTRAS",10,415,200,50,-1,-1)
	...
	$g_idCheck_AllNew = GUICtrlCreateCheckbox("Check to Select All Extras",10,378,350,25,-1,-1)
	GUICtrlSetBkColor(-1, $COL_APP_WINDOW)
	GUICtrlSetFont(-1, 14, 400, 0, "")
	...
	$g_id_lblInfo = GUICtrlCreateLabel("Click ""CHECK EXTRAS"" to Retrieve File List",10,490,450,25,-1,-1)
	GUICtrlSetFont(-1, 14, 400, 0, "")
	GUICtrlSetBkColor(-1,$COL_GROUP_HEADER)
...
func Check_Updates()
	...
	$g_aTV_Event[1] = Populate_TreeView_Advanced($g_aFolderListDetails[2], $g_idTV_Updated, False, True)
...
Func Sync_Updates()
	...
	Local $sMsgBoxMessage = "Downloading of files have finished. Closing ""LazyD Charter - Download Extras""."
